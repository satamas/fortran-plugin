...
class FortranDebugProcess(parameters: RunParameters, session: XDebugSession, consoleBuilder: TextConsoleBuilder)
    ...
    private val myFrameListeners = ContainerUtil.createLockFreeCopyOnWriteList<DataViewFrameListener>()
    ...
    override fun addFrameListener(listener: DataViewFrameListener) {
