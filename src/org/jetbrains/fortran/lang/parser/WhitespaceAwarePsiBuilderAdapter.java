...
public class WhitespaceAwarePsiBuilderAdapter extends PsiBuilderAdapter implements WhitespaceAwarePsiBuilder {

    private final WhitespaceAwarePsiBuilder myBuilder;

    public WhitespaceAwarePsiBuilderAdapter(WhitespaceAwarePsiBuilder builder) {
        super(builder);
