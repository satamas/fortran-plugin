...
public class FortranCompositeElementImpl extends ASTWrapperPsiElement implements FortranCompositeElement {
  public FortranCompositeElementImpl(ASTNode node) {
    super(node);
  }
    ...
    if (text != null) {
      return new ItemPresentation() {
        ...
        public Icon getIcon(boolean b) {
          return FortranCompositeElementImpl.this.getIcon(0);
        }
      };
    }
